...
#ifndef AWINSDK_SWIFT_H
#define AWINSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AwInSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// /import PassKit
SWIFT_CLASS("_TtC7AwInSDK15PurchaseManager")
@interface PurchaseManager : NSObject
@property (nonatomic, weak) id <DataReceiverDelegate> _Nullable delegate;
...
@interface PurchaseManager (SWIFT_EXTENSION(AwInSDK)) <SKProductsRequestDelegate>
...
@interface PurchaseManager (SWIFT_EXTENSION(AwInSDK)) <SKPaymentTransactionObserver>
- (void)paymentQueue:(SKPaymentQueue * _Nonnull)queue updatedTransactions:(NSArray<SKPaymentTransaction *> * _Nonnull)transactions;
@end


@interface SKCloudServiceController (SWIFT_EXTENSION(AwInSDK))
